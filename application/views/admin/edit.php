									...
									<div class="form-row" style="padding: 8px;">
										...
										<div class="card-header border-bottom text-center"
											...
											<div class="mb-3 mx-auto">
												<img id="profile-picture" class="rounded-circle" src="http://localhost/omeltv/assets/images/profile_picture_placeholder.png" alt="User Avatar" width="110"> </div>
...
<script src="http://localhost/omeltv/js/edit_admin.js"></script>
