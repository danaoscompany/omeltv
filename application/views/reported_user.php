...
<div class="container-fluid">
	<div class="row">
		...
		<aside class="main-sidebar col-12 col-md-3 col-lg-2 px-0">
			...
			<?php $this->load->view('sidebar', array('current_menu' => 'reported_user')); ?>
		</aside>
		<!-- End Main Sidebar -->
							...
							<div class="card-body p-0 pb-3 text-center">
								<table class="table mb-0">
									...
									<tr>
										...
										<th scope="col" class="border-0">Pengguna</th>
										<th scope="col" class="border-0">Dilaporkan</th>
										<th scope="col" class="border-0">Alasan</th>
										<th scope="col" class="border-0">Tanggal</th>
										<th scope="col" class="border-0">Blokir</th>
										<th scope="col" class="border-0">Hapus</th>
									</tr>
									</thead>
									<tbody id="reported-users">
									<!--<tr>
										<td>1</td>
										<td>Ali</td>
										<td>Kerry</td>
...
<script src="js/reported_user.js"></script>
</body>
</html>
