									...
									<div class="form-row" style="padding: 8px;">
										...
										<div class="card-header border-bottom text-center"
											...
											<div class="mb-3 mx-auto">
												<img id="profile-picture" class="rounded-circle"
													 src="http://116.193.190.184/omeltv/assets/images/profile_picture_placeholder.png"
													 alt="User Avatar" width="110px" height="110px"></div>
										</div>
										...
										<div class="input-group mb-3" style="margin-top: -4px;">
											<div class="input-group input-group-seamless">
												...
												<input type="text" class="form-control" id="android-id"
													   placeholder="ID Android"></div>
										</div>
										<div class="input-group mb-3" style="margin-top: -4px;">
											<div class="input-group input-group-seamless">
												<select id="looking-for" style="width: 100%;">
													<option>Pilih target gender</option>
													<option>Laki-laki</option>
													<option>Perempuan</option>
												</select>
											</div>
										...
										<div class="input-group mb-3" style="margin-top: -4px;">
											<div class="input-group input-group-seamless">
												<select id="premium" style="width: 100%;">
													<option>Pilih status premium</option>
													<option>Ya</option>
													<option>Tidak</option>
												</select>
											</div>
										...
										<div class="input-group mb-3" style="margin-top: -4px;">
											<div class="input-group input-group-seamless">
												...
												<input type="text" class="form-control" id="subscribed-product-id"
													   placeholder="Kode produk di-subscribe"></div>
										</div>
										<div class="input-group mb-3" style="margin-top: -4px;">
											<div class="input-group input-group-seamless">
												<span class="input-group-prepend">
												...
												<input type="date" class="form-control" id="premium-start"
													   placeholder="Awal premium"></div>
										</div>
										<div class="input-group mb-3" style="margin-top: -4px;">
											<div class="input-group input-group-seamless">
												<span class="input-group-prepend">
...
<input id="edited-user-id" type="text" style="width: 0; height: 0; visibility: hidden;"
	   value="<?php echo $editedUserID; ?>">
...
<script src="http://116.193.190.184/omeltv/js/edit_user.js"></script>
