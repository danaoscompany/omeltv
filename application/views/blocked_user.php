...
<div class="container-fluid">
	<div class="row">
		...
		<aside class="main-sidebar col-12 col-md-3 col-lg-2 px-0">
			...
			<?php $this->load->view('sidebar', array('current_menu' => 'blocked_user')); ?>
		</aside>
		<!-- End Main Sidebar -->
			...
			<div class="main-content-container container-fluid px-4">
				...
				<div class="page-header row no-gutters py-4">
					<div class="col-12 col-sm-4 text-center text-sm-left mb-0">
						<span class="text-uppercase page-subtitle">Pengguna Diblokir</span>
						<h3 class="page-title">Pengguna Diblokir</h3>
					...
					<div class="col">
						...
						<div class="card card-small mb-4" style="margin-top: 8px;">
							<div class="card-header border-bottom">
								<h6 class="m-0">Pengguna Diblokir</h6>
							</div>
							<div class="card-body p-0 pb-3 text-center">
								<table class="table mb-0">
									...
									<tr>
										...
										<th scope="col" class="border-0">Pemblokir</th>
										<th scope="col" class="border-0">Diblokir</th>
										<th scope="col" class="border-0">Tanggal</th>
										<th scope="col" class="border-0">Hapus</th>
									</tr>
									</thead>
									<tbody id="blocked-users">
									<!--<tr>
										<td>1</td>
										<td>Ali</td>
										<td>Kerry</td>
...
<script src="js/blocked_user.js"></script>
</body>
</html>
