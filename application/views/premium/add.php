										...
										<div class="input-group mb-3" style="margin-top: -4px;">
											<div class="input-group input-group-seamless">
												...
												<input type="text" class="form-control" id="name-id"
													   value=""
													   placeholder="Nama (Bahasa Indonesia)"></div>
										</div>
										<div class="input-group mb-3" style="margin-top: -4px;">
											<div class="input-group input-group-seamless">
												<span class="input-group-prepend">
												...
												<input type="text" class="form-control" id="desc-en"
													   value=""
													   placeholder="Deskripsi (English)"></div>
										</div>
										<div class="input-group mb-3" style="margin-top: -4px;">
											<div class="input-group input-group-seamless">
												<span class="input-group-prepend">
												...
												<input type="text" class="form-control" id="desc-id"
													   value=""
													   placeholder="Deskripsi (Bahasa Indonesia)"></div>
										</div>
										<div class="input-group mb-3" style="margin-top: -4px;">
											<div class="input-group input-group-seamless">
												<span class="input-group-prepend">
...
<script src="http://116.193.190.184/omeltv/js/add_premium.js"></script>
